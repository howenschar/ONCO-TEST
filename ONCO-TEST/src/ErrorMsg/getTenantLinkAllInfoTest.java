...
public class getTenantLinkAllInfoTest {

	/**
	 * @throws java.lang.Exception
	 */
	static Logger logger = LogManager.getLogger(getTenantLinkAllInfoTest.class.getName());
	String url;
	...
	public getTenantLinkAllInfoTest(Object caseno, Object method, Object tenant, Object startdate, Object enddate,
	...
	public void setUp() throws Exception {
		...
		url = "/business/getTenantLinkAllInfo.php";
	...
	public void VerifyResponse() {
		...
		logger.info("Test Data: " + this.method + "," + this.tenant + "," + this.startdate + "," + this.enddate + ","
				+ this.request_body + "," + this.response_status + "," + this.response_bodycode + ","
