...
public class getlinkcmpTest {

	/**
	 * @throws java.lang.Exception
	 */
	static Logger logger = LogManager.getLogger(getlinkcmpTest.class.getName());
	String url;
	...
	public getlinkcmpTest(Object caseno, Object method, Object tenant, Object localdevice, Object remotedevice,
			Object network, Object startdate, Object enddate, Object request_body, Object response_status,
			Object response_bodycode, Object response_bodymsg) {
		this.caseno = caseno;
		this.method = method;
		this.tenant = tenant;
	...
	public static Collection getdata() {
		...
		// return Arrays.asList(new Object[][] { { "0", "GET", "DrPeng-Dev",
		// "N/A", "2017-06-21T10:00:00Z",
		// "2017-06-27T10:00:00Z", "", "200.00", "1005.00", "device params
		// exception" } });
	...
	public void VerifyResponse() {
		...
		logger.info("Test Data: " + this.method + "," + this.tenant + "," + this.localdevice + "," + this.remotedevice
				+ "," + this.network + "," + this.startdate + "," + this.enddate + "," + this.request_body + ","
		...
		case "N/A":
			break;
		default:
			paramlist = paramlist + "network=" + network;
		}

		String localdevice = this.localdevice.toString();
		if (paramlist.length() > 0 && !paramlist.endsWith("&"))
			paramlist = paramlist + "&";

		switch (localdevice) {
		case "null":
			paramlist = paramlist + "localdevice=";
			break;
		case "blank":
			paramlist = paramlist + "localdevice=   ";
			break;
		case "N/A":
			break;
		default:
			paramlist = paramlist + "localdevice=" + localdevice;
		}

		String remotedevice = this.remotedevice.toString();
		if (paramlist.length() > 0 && !paramlist.endsWith("&"))
			paramlist = paramlist + "&";

		switch (remotedevice) {
		case "null":
			paramlist = paramlist + "remotedevice=";
			break;
		case "blank":
			paramlist = paramlist + "remotedevice=   ";
			break;
		case "N/A":
			break;
		default:
			paramlist = paramlist + "remotedevice=" + remotedevice;
		}
