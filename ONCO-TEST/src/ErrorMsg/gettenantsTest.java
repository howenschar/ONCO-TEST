...
public class gettenantsTest {
	 ...
	 */
	static Logger logger = LogManager.getLogger(gettenantsTest.class.getName());
	String url;
	...
	public gettenantsTest(Object caseno, Object method, Object request_body, Object response_status,
	...
	public void VerifyResponse() {
		...
		logger.info("Test Data: " + this.method + "," + this.request_body + ","
