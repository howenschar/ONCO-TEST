...
public class gettenantlinkinfoTest {

	/**
	 * @throws java.lang.Exception
	 */
	static Logger logger = LogManager.getLogger(gettenantlinkinfoTest.class.getName());
	...
	public gettenantlinkinfoTest(Object caseno, Object method, Object tenant, Object request_body, Object response_status,
	...
	public void VerifyResponse() {
		...
		String url = "/business/gettenantlinkinfo.php";
		switch (tenantname) {
		case "null":
			url = url + "?tenantname=";
			break;
