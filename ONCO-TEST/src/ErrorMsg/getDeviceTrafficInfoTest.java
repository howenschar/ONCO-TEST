...
public class getDeviceTrafficInfoTest {

	/**
	 * @throws java.lang.Exception
	 */
	static Logger logger = LogManager.getLogger(getDeviceTrafficInfoTest.class.getName());
	String url;
	...
	public getDeviceTrafficInfoTest(Object caseno, Object method, Object tenant, Object device, Object startdate,
			Object enddate, Object request_body, Object response_status, Object response_bodycode,
			Object response_bodymsg) {
		this.caseno = caseno;
		this.method = method;
		this.tenant = tenant;
		this.device = device;
	...
	public void setUp() throws Exception {
		...
		url = "/business/getDeviceTrafficInfo.php";
	...
	public void VerifyResponse() {
		...
		logger.info("Test Data: " + this.method + "," + this.tenant + "," + this.device + "," + this.startdate + ","
		...
		String device = this.device.toString();
		if (paramlist.length() > 0 && !paramlist.endsWith("&"))
			paramlist = paramlist + "&";

		switch (device) {
		case "null":
			paramlist = paramlist + "device=";
			break;
		case "blank":
			paramlist = paramlist + "device=   ";
			break;
		case "N/A":
			break;
		default:
			paramlist = paramlist + "device=" + device;
		}
